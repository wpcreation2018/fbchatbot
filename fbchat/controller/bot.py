...
class EchoBot(Client):
    def onMessage(self, author_id, message_object, thread_id, thread_type, **kwargs):
        ...
        if message_object.text in askmore_list:
            ...
            self.setTypingStatus(TypingStatus.TYPING, thread_id=thread_id, thread_type=thread_type)
            self.send(Message(text="ชอบชุดไหน ส่งรูปภาพมาได้เลยจ้า"), thread_id=thread_id, thread_type=thread_type)
            self.setTypingStatus(TypingStatus.STOPPED, thread_id=thread_id, thread_type=thread_type)
        ...
        if message_object.text in init_list:
            ...
            # Use when long AFK
            #self.setTypingStatus(TypingStatus.TYPING, thread_id=thread_id, thread_type=thread_type)
            #self.send(Message(text=functions.goto_lineadd()), thread_id=thread_id, thread_type=thread_type)
            #self.setTypingStatus(TypingStatus.STOPPED, thread_id=thread_id, thread_type=thread_type)
